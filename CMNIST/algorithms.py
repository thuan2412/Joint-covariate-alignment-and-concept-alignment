...
#         loss = nll 
#         loss += irm_penalty_weight * irm_penalty
#         loss += ib_penalty_weight * ib_penalty*0  ### 0 since we want IRM-MMD only i.e, making ib_penalty zero
#         loss += mmd_penalty * mmd_penalty_weight
...
#         loss = nll 
#         loss += irm_penalty_weight * irm_penalty
#         loss += ib_penalty_weight * ib_penalty #### involing ib_penalty which is conditional entropy term 
#         loss += mmd_penalty * mmd_penalty_weight
...
#         loss = nll 
#         loss += irm_penalty_weight * irm_penalty
#         loss += ib_penalty_weight * ib_penalty #### conditional entropy term 
#         loss += mmd_penalty * mmd_penalty_weight ### coral alignment term
