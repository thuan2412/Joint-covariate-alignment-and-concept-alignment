...
if __name__ == "__main__":
    ...
    parser.add_argument('--command', choices=['launch', 'delete_incomplete'])  # choices=['launch', 'delete_incomplete'],
    ...
    parser.add_argument('--output_dir', type=str, default="./domainbed/outputThuan/path") ## thuan added
    parser.add_argument('--data_dir', type=str, default="./domainbed/data/path") ## thuan added
    parser.add_argument('--seed', type=int, default=0)
    parser.add_argument('--n_trials', type=int, default=2)
    parser.add_argument('--command_launcher', default ='local', type=str, required=True)
